                        ...
                        <div class="job-item p-4 mb-4">
                            <div class="row g-4">
                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img class="flex-shrink-0 img-fluid border rounded" src="{{ asset('images/' . $job->image_path) }}" alt="" style="width: 80px; height: 80px;">
                                ...
                                <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                    <div class="d-flex mb-3">
                                        <a class="btn btn-warning me-3" href="jobs/{{ $job->id }}/edit">Sửa</a>
                                        <form action="jobs/{{ $job->id }}" method="POST">
                                            @csrf
                                            @method('delete')  
                                            <button type="submit" class="btn btn-danger me-3">Xóa</button>  
                                        </form>
                                        <a class="btn btn-light btn-square me-3" title="Thêm vào yêu thích" href=""><i class="far fa-heart text-primary"></i></a>
                                        <a class="btn btn-primary" href="/jobs/{{ $job->id }}">Xem ngay</a>
                                    </div>
                                    <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>Hết hạn sau: {{ $job->created_at }}</small>
                                </div>
                            </div>
                        </div>
                    @endforeach
