            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">Tôi là quản trị viên của công ty này.</p>

                  <h5 class="card-title">Chi tiết hồ sơ cá nhân</h5>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Duy Tan, TP Vinh</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">(84) 377888433</div>
                  </div>
